...
namespace QuickTypeWeather
{
    ...
    public partial class Weather
    {
        public static Weather FromJson(string json) => JsonConvert.DeserializeObject<Weather>(json, QuickTypeWeather.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Weather self) => JsonConvert.SerializeObject(self, QuickTypeWeather.Converter.Settings);
    }
